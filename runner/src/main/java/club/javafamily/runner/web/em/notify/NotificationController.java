...
import club.javafamily.runner.common.model.amqp.StringWrapper;
...
public class NotificationController {
   ...
   public void notify(@RequestBody StringWrapper message) {
      notificationService.sendNotification(message.getContent());
   }
