...
public abstract class BaseChartVisualMapFactory implements ChartObjectFactory<EChartVisualMap> {
   protected BaseChartVisualMapFactory(ChartHelper chartHelper) {
